/**
 * 所有静态文案与链接集中在此，便于后续接入 next-intl 时无需改动组件。
 */
...
export const docsNav = [
  ...
  },
  {
    ...
    items: [
      ...
      { label: "模块划分", href: "/docs/modules" },
      { label: "数据流", href: "/docs/data-flow" },
      { label: "WebRTC 与 SFU", href: "/docs/webrtc" },
    ],
  },
  {
    title: "核心概念",

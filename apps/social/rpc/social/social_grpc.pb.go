...
const (
	...
	Social_FriendPutInIgnore_FullMethodName       = "/social.social/FriendPutInIgnore"
...
type SocialClient interface {
	...
	FriendPutInIgnore(ctx context.Context, in *FriendPutInIgnoreReq, opts ...grpc.CallOption) (*FriendPutInIgnoreResp, error)
...
func (c *socialClient) FriendPutInIgnore(ctx context.Context, in *FriendPutInIgnoreReq, opts ...grpc.CallOption) (*FriendPutInIgnoreResp, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(FriendPutInIgnoreResp)
	err := c.cc.Invoke(ctx, Social_FriendPutInIgnore_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SocialServer interface {
	...
	FriendPutInIgnore(context.Context, *FriendPutInIgnoreReq) (*FriendPutInIgnoreResp, error)
...
func (UnimplementedSocialServer) FriendPutInIgnore(context.Context, *FriendPutInIgnoreReq) (*FriendPutInIgnoreResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FriendPutInIgnore not implemented")
}
...
func _Social_FriendPutInIgnore_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(FriendPutInIgnoreReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SocialServer).FriendPutInIgnore(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Social_FriendPutInIgnore_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SocialServer).FriendPutInIgnore(ctx, req.(*FriendPutInIgnoreReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Social_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "FriendPutInIgnore",
			Handler:    _Social_FriendPutInIgnore_Handler,
		},
		{

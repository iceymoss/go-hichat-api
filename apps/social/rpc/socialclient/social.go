...
type (
	...
	FriendPutInIgnoreReq        = social.FriendPutInIgnoreReq
	FriendPutInIgnoreResp       = social.FriendPutInIgnoreResp
...
func (m *defaultSocial) FriendPutInIgnore(ctx context.Context, in *FriendPutInIgnoreReq, opts ...grpc.CallOption) (*FriendPutInIgnoreResp, error) {
	client := social.NewSocialClient(m.cli.Conn())
	return client.FriendPutInIgnore(ctx, in, opts...)
}

...
func (s *SocialServer) GroupSearch(ctx context.Context, in *social.GroupSearchReq) (*social.GroupSearchResp, error) {
	l := logic.NewGroupSearchLogic(ctx, s.svcCtx)
	return l.GroupSearch(in)
}

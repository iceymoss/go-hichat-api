...
func (s *SocialServer) FriendPutInIgnore(ctx context.Context, in *social.FriendPutInIgnoreReq) (*social.FriendPutInIgnoreResp, error) {
	l := logic.NewFriendPutInIgnoreLogic(ctx, s.svcCtx)
	return l.FriendPutInIgnore(in)
}

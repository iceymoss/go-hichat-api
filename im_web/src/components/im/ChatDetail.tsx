...
function MessageList({
  ...
  const GROUP_INTERVAL = 3 * 60 * 1000; // 3 min

  // Build groups: time separators + message groups
  const groups: { type: 'time'; time: string; key: string } | { type: 'msg'; msgs: typeof messages; key: string }[] = [];
  let lastTime = 0;

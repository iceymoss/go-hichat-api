CREATE TABLE trend (
    ...
    -- 双平台状态控制 --
                       circle_state TINYINT(1) NOT NULL DEFAULT 1 COMMENT '朋友圈状态：2-不可见，1-可见，0-朋友圈删除',
                       public_state TINYINT(1) NOT NULL DEFAULT 0 COMMENT '公共论坛状态：3-未发布，1-已发布，2-审核中，0-论坛删除',

    -- 双平台时间管理 --
                       circle_time DATETIME DEFAULT CURRENT_TIMESTAMP COMMENT '朋友圈发布时间',
                       public_time DATETIME DEFAULT NULL COMMENT '公共论坛发布时间',

                       state TINYINT(1) NOT NULL DEFAULT 0 COMMENT '是否删除 0-删除，1-正常',
